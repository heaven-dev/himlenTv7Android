...
abstract public class Constants {
    ...
    public static final String EPG_CHANNEL = "SV1";
    public static final String EPG_LANG = "sv";
    ...
    public static final List<sv.tv7.himlentv7.helpers.MenuItem> MENU_ITEM_IDS = new ArrayList<>(Arrays.asList(
        new sv.tv7.himlentv7.helpers.MenuItem(R.id.tvMenuContainer, R.id.tvMenuText),
        new sv.tv7.himlentv7.helpers.MenuItem(R.id.archiveMenuContainer, R.id.archiveMenuText),
        new sv.tv7.himlentv7.helpers.MenuItem(R.id.guideMenuContainer, R.id.guideMenuText),
        new sv.tv7.himlentv7.helpers.MenuItem(R.id.searchMenuContainer, R.id.searchMenuText)
    ));
