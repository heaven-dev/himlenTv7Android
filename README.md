...
This application is already in the [Google Play store](https://play.google.com/store/apps/details?id=sv.tv7.himlentv7). There are some screenshots of the application.
...
### Clone repository
  - Clone this repository to your computer disk.
    - __git clone https://github.com/heaven-dev/himlenTv7Android.git__
...
### License
 - [MIT](https://github.com/heaven-dev/himlenTv7Android/blob/master/LICENSE.md)
